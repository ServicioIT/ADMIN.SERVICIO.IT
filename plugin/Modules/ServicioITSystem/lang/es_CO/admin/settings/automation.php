...
return [
    'billing' => [
        'description' => 'Configurar automatización de facturación y recordatorios.',
        'title' => 'Facturación'
    ],
    'description' => 'Configurar tareas automatizadas del sistema.',
    'scheduling' => [
        'description' => 'Configurar programación de tareas automatizadas.',
        'title' => 'Programación'
    ],
    'service' => [
        'description' => 'Configurar acciones automatizadas para servicios.',
        'title' => 'Servicio'
    ],
    'ticket' => [
        'description' => 'Configurar cierre automático de tickets.',
        'title' => 'Tickets'
    ],
    ...
    'invoice_auto_cancel_days_label' => 'Auto Cancelar No Pagado Facturas',
    'invoice_auto_cancel_days_helper' => 'Cancelar unpaid invoices automatically after this many days overdue (Leave 0 to disable).',
    ...
    'auto_accept_cancellation_label' => 'Auto Accept Cancelarlation Requests',
    ...
    'ticket_close_days_label' => 'Auto Cerrar Inactivo Tickets',
    ...
    'prune_ticket_attachments_days_label' => 'Prune Ticket Adjuntos',
