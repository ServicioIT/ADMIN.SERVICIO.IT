...
return [
    'service_number_label' => 'Servicio Number',
    'package_label' => 'Paquete',
    'catalog_label' => 'Catálogo',
    'registration_label' => 'Registration Fecha',
    ...
    'additional_information_label' => 'Additional Informaciónrmation',
    'cancel_label' => 'Cancelarlation Request',
    'scale_label' => 'Scaling Servicio',
    ...
    'cancellation' => [
        'type_label' => 'Cancelarlation Tipo',
        'reason_label' => 'Cancelarlation Reason',
        'requested' => 'Cancelarlation request has been submitted.',
        'pending' => 'This service has a pending cancellation request. Please contact support if you wish to withdraw it.'
    ],
    'scaling' => [
        'current_label' => 'Current Paquete',
        'current_amount_label' => 'Current Recurrente Monto',
        'new_amount_label' => 'New Recurrente Monto',
        ...
        'upgrade_success' => 'Upgrade invoice ha sido creado. Complete your payment to apply the changes.',
        'invoice_item_description' => ':old_package scale to :new_package (Prorated for :days day(s))'
    ],
    'provisioning' => [
        'not_found' => 'Aprovisionamiento provider not found.',
        'unavailable' => 'Aprovisionamiento provider unavailable.'
    ]
];
