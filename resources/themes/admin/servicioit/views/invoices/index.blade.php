            ...
            <div class="w-full md:w-100">
                <form action="{{ route('admin.invoices') }}" method="GET"
                    ...
                    <input type="text" name="search" id="search" placeholder="{{ __('admin/common.search') }}"
                        ...
                        class="w-full px-4 py-2.5 pl-10 bg-white text-slate-700 placeholder:text-slate-500 border-2 border-billmora-neutral-100 rounded-xl group-focus-within:outline-2 outline-billmora-primary-500">
