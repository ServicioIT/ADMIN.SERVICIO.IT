        ...
        <div class="flex flex-col md:flex-row gap-4 justify-between items-center">
            <div class="w-full md:w-100">
                <form action="{{ route('admin.users.activity', ['user' => $user->id]) }}" method="GET" class="relative inline-block max-w-150 w-full group">
                    ...
                    <input type="text" name="searchActiviyUser" id="searchActiviyUser" placeholder="{{ __('admin/common.search') }}" value="{{ request('searchActiviyUser') }}" class="w-full px-6 py-3 pl-10 bg-white text-slate-700 placeholder:text-slate-500 border-2 border-billmora-neutral-100 rounded-xl group-focus-within:outline-2 outline-billmora-primary-500">
